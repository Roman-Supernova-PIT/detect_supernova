...
def skymatch_and_join(left_table, right_table, left_skycoord, right_skycoord, match_radius=None):
    ...
    matched_status, matched_id = two_direction_skymatch(left_skycoord, right_skycoord, radius=match_radius * u.arcsec)
